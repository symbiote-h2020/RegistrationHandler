...
public class DummyAAMRestListeners {
    ...
    public ResponseEntity<List<AAM>> getAvailableAAMs() {
        ...
        try {
            ...
            String coreAAMInstanceIdentifier = "securityHandlerTestPlatformAAM";

            // adding core aam info to the response
            availableAAMs.add(new AAM("http://localhost:8080", "Test Platform", coreAAMInstanceIdentifier, coreCertificate));
